...
#         self.assertEqual(data.get("title"), Lesson.objects.get(pk=2).title)
#
...
#         print(response.json())
#         self.assertEqual(response.status_code, status.HTTP_200_OK)
#         self.assertEqual(response.json().get("is_subscribed"), "подписка оформлена")
